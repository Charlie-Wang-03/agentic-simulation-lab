"""Minimal official PyAEDT Student Maxwell create/save/close smoke test."""
...
def main() -> int:
    ...
    try:
        ...
        app = Maxwell3d(
            project="MaxwellConnectSmoke",
            design="Maxwell3D_Smoke",
            solution_type="Magnetostatic",
            **kwargs,
        )
        owned_pid = getattr(app.desktop_class, "aedt_process_id", None)
        project_file = OUTPUT_ROOT / "smoke" / "maxwell_connect_smoke.aedt"
